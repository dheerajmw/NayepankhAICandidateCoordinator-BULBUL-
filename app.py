...
with st.sidebar:
    ...
    st.page_link("pages/1_Candidate_Apply.py", label="Apply as Volunteer", icon="📝")
    st.page_link("pages/2_Admin_Dashboard.py", label="Admin Dashboard", icon="⚙️")
    st.page_link("pages/3_Task_Assignment.py", label="Task Assignment", icon="🎯")

render_header = lambda: status_pills(
    [
        (storage_label(), True),
...
st.caption("Use the sidebar to open **Apply as Volunteer**, **Admin Dashboard**, or **Task Assignment**.")
